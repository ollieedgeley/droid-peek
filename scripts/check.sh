...
run_check "lint QML" "$qt6_bin/qmllint" -I "$lint_root" BarWidget.qml Panel.qml qml/components/PhonePreview.qml qml/components/PhoneToolbar.qml qml/components/Settings.qml qml/state/PairingState.qml qml/state/SemanticActionRouter.qml
